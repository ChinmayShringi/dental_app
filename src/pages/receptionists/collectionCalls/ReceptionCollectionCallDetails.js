...
class ReceptionCollectionCallDetails extends Component {
  api = new Api();
  ...
  getData() {
    ...
    let options = {
      api: 'v_1/receptionists/collection-calls/view',
      method: 'POST',
      headers: {
...
export default connect(mapStateToProps, null)(ReceptionCollectionCallDetails);
