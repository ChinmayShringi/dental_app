...
class ReceptionComplaintDetails extends Component {
  api = new Api();
  ...
  getData() {
    ...
    let options = {
      api: 'v_1/receptionists/complaints/view',
      method: 'POST',
      headers: {
                  ...
                  <View style={mapWithDetailsLayout.detailsContainer}>
                    ...
                    <View style={mapWithDetailsLayout.buttonsBlockContainer}>
                      ...
                      <TouchableOpacity
                        style={mapWithDetailsLayout.buttonContainer}
                        onPress={() => {
                          this.props.navigation.push('ReceptionComplaintForm', {
...
export default connect(mapStateToProps, null)(ReceptionComplaintDetails);
