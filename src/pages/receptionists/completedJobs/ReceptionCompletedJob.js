...
export default class ReceptionCompletedJob extends Component {
  ...
  getData() {
    ...
    let options = {
      api: 'v_1/receptionists/jobs/completed/view',
      method: 'POST',
      headers: {
  ...
  modalFormHandleSubmit = values => {
    ...
    let options = {
      api: 'v_1/receptionists/jobs/completed/rework/store',
      method: 'POST',
      headers: {
        Accept: 'application/json',
      },
