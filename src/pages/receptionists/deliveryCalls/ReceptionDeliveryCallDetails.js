...
class ReceptionDeliveryCallDetails extends Component {
  api = new Api();
  ...
  getData() {
    ...
    let options = {
      api: 'v_1/receptionists/delivery-calls/view',
      method: 'POST',
      headers: {
...
export default connect(mapStateToProps, null)(ReceptionDeliveryCallDetails);
