...
class ReceptionDeliveryCalls extends Component {
  api = new Api();
  ...
  getData() {
    ...
    let options = {
      api: 'v_1/receptionists/delivery-calls/load',
      method: 'POST',
      headers: {
        ...
        <View
          ...
          <SkeletonContent
            ...
            <Fab
              ...
              onPress={() => {
                this.props.navigation.push('ReceptionDeliveryCallForm', {
                  pageHeading: 'Add Delivery Call',
                });
              }}>
              <Icon name="plus" />
            </Fab>
...
export default connect(mapStateToProps, null)(ReceptionDeliveryCalls);
