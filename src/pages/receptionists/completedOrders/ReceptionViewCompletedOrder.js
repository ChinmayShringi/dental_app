...
export default class ReceptionViewCompletedOrder extends Component {
  api = new Api();
  ...
  downloadInvoice = () => {
    ...
    let options = {
      api: 'v_1/receptionists/orders/completed/invoice/download',
      method: 'POST',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'multipart/form-data',
  ...
  sendInvoiceToCustomer = () => {
    ...
    let options = {
      api: 'v_1/receptionists/orders/completed/invoice/sent-to-customer',
      method: 'POST',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'multipart/form-data',
                ...
                {this.state.order !== null && !this.state.loading ? (
                  <View>
                    ...
                    <Button
                      ...
                      onPress={this.sendInvoiceToCustomer}>
                      <Icon
                        name="file-text-o"
                        style={{
                          fontSize: 20,
