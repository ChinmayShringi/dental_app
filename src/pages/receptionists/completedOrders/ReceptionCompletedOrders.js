...
export default class ReceptionCompletedOrders extends Component {
  api = new Api();
  ...
  getData() {
    ...
    let options = {
      api: 'v_1/receptionists/orders/completed/load',
      method: 'POST',
      headers: {
      ...
      <View>
        <Card style={callLogCardLayout.cardContainer}>
          <TouchableOpacity
            activeOpacity={0.5}
            onPress={() => {
              this.props.navigation.push('ReceptionViewCompletedOrder', {
