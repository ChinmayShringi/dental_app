                    ...
                    <View
                      ...
                      <View style={{alignSelf: 'flex-end'}}>
                        <View style={{flex: 1, flexDirection: 'row'}}>
                          <Badge
                            style={badgeCss(
                              this.state.saleslead.statustextcolor,
                            )}>
                            <Text style={common.bagdeText}>
                              {this.state.saleslead.statustext}
                            </Text>
                          </Badge>
                        </View>
                      </View>
...
export default connect(mapStateToProps, null)(LeadDetails);
