...
class CollectionCallForm extends Component {
  api = new Api();
  ...
  getFormData() {
    ...
    if (this.state.callLogId === 0) {
      options.api = 'v_1/sales/collection-calls/add';
    } else {
      options.api = 'v_1/sales/collection-calls/edit';
    }
  ...
  handleChangeCustomer = customerId => {
    if (this.state.customerId !== customerId) {
      ...
      if (parseInt(customerId) > 0) {
        ...
        this.api
          .callPostApi({
            api: 'v_1/sales/collection-calls/get-customer-address',
            method: 'POST',
            headers: {
              Accept: 'application/json',
              'Content-Type': 'multipart/form-data',
  ...
  handleSubmit = values => {
    ...
    let options = {
      api: 'v_1/sales/collection-calls/store',
      method: 'POST',
      headers: {
        Accept: 'application/json',
      },
...
export default connect(mapStateToProps, null)(CollectionCallForm);
