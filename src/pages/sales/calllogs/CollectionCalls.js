...
class CollectionCalls extends Component {
  api = new Api();
  ...
  getData() {
    ...
    let options = {
      api: 'v_1/sales/collection-calls/load',
      method: 'POST',
      headers: {
        ...
        <Card style={callLogCardLayout.cardContainer}>
          <TouchableOpacity
            ...
            <CardItem style={[callLogCardLayout.cardBodyWithOutFooter]}>
              <Body>
                {/* <Text style={callLogCardLayout.bodyTitle}>
                                    {item.customername}
                                </Text> */}
...
export default connect(mapStateToProps, null)(CollectionCalls);
