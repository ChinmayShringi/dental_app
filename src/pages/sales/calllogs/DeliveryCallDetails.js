...
class DeliveryCallDetails extends Component {
  api = new Api();
  ...
  getData() {
    ...
    let options = {
      api: 'v_1/sales/delivery-calls/view',
      method: 'POST',
      headers: {
                  ...
                  <View style={mapWithDetailsLayout.detailsContainer}>
                    ...
                    <View style={mapWithDetailsLayout.buttonsBlockContainer}>
                      ...
                      <TouchableOpacity
                        style={mapWithDetailsLayout.buttonContainer}
                        onPress={() => {
                          this.props.navigation.push('DeliveryCallForm', {
                            pageHeading: 'Edit Delivery Call',
                    ...
                    <View
                      ...
                      <View
                        ...
                        <View style={styles.descriptionContainer}>
                          <Text style={commonLabelDescription.labelValue}>
                            {this.state.calllog.displaypickupdate}
                          </Text>
                        </View>
                      </View>
                      <View
                        ...
                        <View style={styles.descriptionContainer}>
                          <Text style={commonLabelDescription.labelValue}>
                            {this.state.calllog.displaypickuprequesttime}
                          </Text>
                        </View>
                      </View>
                      <View
                        ...
                        <View style={styles.descriptionContainer}>
                          <Text style={commonLabelDescription.labelValue}>
                            {this.state.calllog.displaypickuptime}
                          </Text>
                        </View>
                      </View>
                      <View
                        ...
                        <View style={styles.descriptionContainer}>
                          <Text style={commonLabelDescription.labelValue}>
                            {this.state.calllog.displaydeliverytime}
                          </Text>
                        </View>
                      </View>
                      <View
                        ...
                        <View style={styles.descriptionContainer}>
                          <Text style={commonLabelDescription.labelValue}>
                            {this.state.calllog.displayreceivedtime}
                          </Text>
                        </View>
                      </View>
                      <View
...
export default connect(mapStateToProps, null)(DeliveryCallDetails);
