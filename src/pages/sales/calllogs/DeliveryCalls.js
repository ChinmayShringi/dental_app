...
class DeliveryCalls extends Component {
  api = new Api();
  ...
  getData() {
    ...
    let options = {
      api: 'v_1/sales/delivery-calls/load',
      method: 'POST',
      headers: {
        ...
        <View
          ...
          <SkeletonContent
            ...
            {/* <Fab
                            ...
                            onPress={() =>  {
                                this.props.navigation.push('DeliveryCallForm', { 'pageHeading': 'Add Delivery Call' })
                            } }
                        >
                            <Icon name="plus" />
                        </Fab> */}
...
export default connect(mapStateToProps, null)(DeliveryCalls);
