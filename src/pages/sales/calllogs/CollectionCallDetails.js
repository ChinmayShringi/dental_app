...
class CollectionCallDetails extends Component {
  api = new Api();
  ...
  getData() {
    ...
    let options = {
      api: 'v_1/sales/collection-calls/view',
      method: 'POST',
      headers: {
                  ...
                  <View style={mapWithDetailsLayout.detailsContainer}>
                    ...
                    <View style={mapWithDetailsLayout.buttonsBlockContainer}>
                      ...
                      <TouchableOpacity
                        style={mapWithDetailsLayout.buttonContainer}
                        onPress={() => {
                          this.props.navigation.push('CollectionCallForm', {
                    ...
                    <View
                      ...
                      <View
                        ...
                        <View style={styles.descriptionContainer}>
                          <Text style={commonLabelDescription.labelValue}>
                            {this.state.calllog.typeofworktext}
                          </Text>
                        </View>
                      </View>
                      <View
                      ...
                      <View
                        ...
                        <View style={styles.descriptionContainer}>
                          {this.state.calllog.pickuptime !== '' &&
                          this.state.calllog.pickuptime !== null ? (
                            <Text style={commonLabelDescription.labelValue}>
...
export default connect(mapStateToProps, null)(CollectionCallDetails);
