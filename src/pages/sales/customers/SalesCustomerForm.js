...
export default class SalesCustomerForm extends Component {
  api = new Api();
  ...
  getFormData() {
    ...
    if (this.state.customerId === 0) {
      options.api = 'v_1/sales/customers/add';
    } else {
      options.api = 'v_1/sales/customers/edit';
    }
              ...
              <View style={common.formElementsContainer}>
                <Formik
                  ...
                  {formikProps => {
                    ...
                    return (
                      <View>
                        <Text style={[styles.blockTitle, {paddingTop: 0}]}>
                          Customer Details:
                        </Text>
                        <FormSelectPicker
                          label="Type"
