...
export default class ProductionAssignedJobs extends Component {
  api = new Api();
  ...
  getData() {
    ...
    let options = {
      api: 'v_1/productions/jobs/assigned/load',
      method: 'POST',
      headers: {
  ...
  redirectToQrCodeScanningPage = () => {
    this.props.navigation.navigate('ProductionScanQrCodeForAssignedJob', {});
  };
