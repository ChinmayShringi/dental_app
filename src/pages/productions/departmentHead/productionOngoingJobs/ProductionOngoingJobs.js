...
export default class productionOngoingJobs extends Component {
  api = new Api();
  ...
  getData() {
    ...
    let options = {
      api: 'v_1/productions/jobs/ongoings/load',
      method: 'POST',
      headers: {
  ...
  redirectToQrCodeScanningPage = () => {
    console.log('here');
    this.props.navigation.navigate('ProductionScanQrCodeForOngoingJob', {});
  };
