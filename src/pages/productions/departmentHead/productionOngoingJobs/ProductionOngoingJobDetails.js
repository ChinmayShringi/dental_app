...
export default class ProductionOngoingJobDetails extends Component {
  api = new Api();
  ...
  getData() {
    ...
    if (this.state.isFromQrCode) {
      options.api = 'v_1/productions/jobs/ongoings/view-by-qrcode';
    } else {
      options.api = 'v_1/productions/jobs/ongoings/view';
    }
                      ...
                      <View
                        ...
                        <View style={styles.descriptionContainer}>
                          ...
                          this.state.productionProcess.userid !== '' ? (
                            // <Text>{this.state.productionProcess.username}</Text>
                            <TouchableOpacity
                              onPress={() => {
                                this.props.navigation.push(
                                  'ProductionEmployeeDetails',
                                  {
                                    ...
                                    userId: this.state.productionProcess.userid,
                                  },
                                );
                              }}>
                              <Text
