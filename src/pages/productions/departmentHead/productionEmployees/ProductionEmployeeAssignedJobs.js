...
export default class SupervisorJobs extends Component {
  api = new Api();
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      pageHeading:
        typeof this.props.navigation
          .dangerouslyGetParent()
          .getParam('pageHeading') !== 'undefined'
          ? this.props.navigation.dangerouslyGetParent().getParam('pageHeading')
          : 'Job Details',
      data: [],
      currentPage: 1,
      lastPage: 1,
  ...
  getData() {
    ...
    let options = {
      api: 'v_1/productions/users/jobs/load',
      method: 'POST',
      headers: {
      ...
      <View>
        <Card style={callLogCardLayout.cardContainer}>
          <TouchableOpacity
            activeOpacity={0.5}
            onPress={() => {
              this.props.navigation.push('ProductionEmployeeAssignedJob', {
