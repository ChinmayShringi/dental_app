...
export default class CustomerViewOrderDetails extends Component {
  api = new Api();
      ...
      <View>
        <Card style={callLogCardLayout.cardContainer}>
          <TouchableOpacity
            activeOpacity={0.5}
            onPress={() => {
              this.props.navigation.push('CustomerViewJob', {
              ...
              <Body>
                ...
                <View
                  ...
                  <View
                    ...
                    <Text style={commonLabelDescription.labelText}>Brand</Text>
                  </View>
                  <View style={commonLabelDescription.listSeperator}>
                    <Text style={commonLabelDescription.labelText}>:</Text>
                  </View>
                ...
                <View
                  ...
                  <View style={styles.descriptionContainer}>
                    <View>
                      {item.poticdesign !== null && item.poticdesign !== '' ? (
                        <Text style={commonLabelDescription.labelValue}>
                ...
                <View
                  ...
                  <View
                    ...
                    <Text style={commonLabelDescription.labelText}>Shade</Text>
                  </View>
                  <View style={commonLabelDescription.listSeperator}>
                    <Text style={commonLabelDescription.labelText}>:</Text>
                  </View>
          ...
          <SkeletonContent
            ...
            <View
              style={[
                ...
                {backgroundColor: backgroundGrey, paddingTop: 0, marginTop: 0},
              ]}>
              <TeethSkeleton
                isClickable={false}
