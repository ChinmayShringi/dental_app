...
export default class CustomerViewProfile extends Component {
  api = new Api();
  ...
  getData() {
    let options = {
      api: 'v_1/customers/view-profile',
      method: 'POST',
      headers: {
  ...
  render() {
    const skeletonLayout = [
      ...
      //     width: 24,
      //     height: (this.props.user !== null && this.props.user.isdepartmenthead) ? 20 : 0,
      //     borderRadius: 2,
      //     marginTop: 0,
      // },
      {
