...
export default class SupervisorRework extends Component {
  ...
  getData() {
    ...
    let options = {
      api: 'v_1/supervisors/reworks/view',
      method: 'POST',
      headers: {
    ...
    this.api.callPostApi(options).then(data => {
      ...
      if (data.status_code === 200) {
        ...
        this.setState({
          ...
          productionSteps: responseData.productionsteps,
        });
      } else {
  ...
  handleChangeProductionStep = productionStepId => {
    if (this.state.productionStepId !== productionStepId) {
      this.setState({productionStepId});
    }
  };
  ...
  modalFormHandleSubmit = values => {
    ...
    formData.append(
      'productionstepid',
      this.state.productionStepId === null ? '' : this.state.productionStepId,
    );

    let options = {
      api: 'v_1/supervisors/reworks/send-to-production',
      method: 'POST',
      headers: {
        Accept: 'application/json',
      },
  ...
  modalFormValidate(values) {
    ...
    if (
      this.state.productionStepId == null ||
      this.state.productionStepId === ''
    ) {
      errors.productionstepid = 'Please select production step.';
    }
                                        ...
                                        return (
                                          <View>
                                            <FormSelectPicker
                                              ...
                                              onValueChange={
                                                this.handleChangeProductionStep
                                              }
                                              items={this.state.productionSteps}
                                              errors={errors.productionstepid}
                                            />
                                          </View>
                                        );
                                      }}
