...
import { View, Text, Image, ImageBackground, Button, StyleSheet, TouchableOpacity, Platform } from "react-native";

import Dataprovider from '../provider/Dataprovider';
import Api from '../provider/Api';

import { primaryBlueHexColor, primaryHexColor, fontColor, circleBgColor } from '../constants/themeColors';
        ...
        return(
                ...
                onPress={() => {
                    if(!this.state.isLoading) {
                        ...
                        api.callPostApi(options).then(responseData => {
                            ...
                            // Customer
                            if(this.props.user.usertype === 4 || this.props.user.usertype === "4") {
                            }
                            // Users
                            else {
            ...
            >  
                ...
                {!this.state.isLoading ? 
                    ...
                    :
                    <View 
                        style={{ justifyContent: 'flex-start', flexDirection: 'row', opacity: 0.4 }}
                    >
