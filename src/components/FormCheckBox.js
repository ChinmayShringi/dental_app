    ...
    return (
        <View style={styles.inputContainer}>
            ...
            <View
                ...
                }, isMultiLine ? styles.elementContainerBorderRadiusMultiLine : styles.elementContainerBorderRadiusSingleLine]}
                onLayout={onLayout}
            >
                <Text
                    style={{
                ...
                {options.map((option, index) => {
                    return (
                        <CheckBox
                            ...
                            checked={value.some(enclosure => option.value === enclosure) ? true : false}
                            checkedIcon='check-square-o'
                            uncheckedIcon='square-o'
                            containerStyle={styles.containerStyle}
                            checkedColor={primaryPurpleHexColor}
                            size={14}
                            textStyle={{ fontSize: 13, fontWeight: 'normal', color: fontColor, marginLeft: 2, marginRight: 10, marginTop: -3 }}
