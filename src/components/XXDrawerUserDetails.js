...
class XXDrawerUserDetails extends Component {
    ...
    render() {
        return(
            <ImageBackground source={require('../images/login-balloon.jpg')} style={{width: undefined, padding: 16, paddingTop: 32}}>
                ...
                <Text style={styles.name}>{this.props.user != null ? this.props.user.fullname : 'NA' }</Text>
                <Text style={styles.email}>{this.props.user != null ? this.props.user.email : 'NA' }</Text>
